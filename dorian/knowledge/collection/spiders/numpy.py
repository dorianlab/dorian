...
class NumpySpider(scrapy.Spider):
    name = "numpy_spider"
    language = 'python'
    ...
    def parse(self, response):
        yield response.follow("https://numpy.org/doc/_static/versions.json",self.parseAllVersions)        
    ...
    def getAllParentCategoryTable(self,response):
        parentCatTable = response.xpath("//*[@class='toctree-wrapper compound']/ul/li/a/following-sibling::*/li/a")
